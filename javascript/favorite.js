$(document).ready(function(){
    ...
    for(var i=1;i<7;i++){
        name_list.push("mouse" + i.toString() + "_star");
        name_list.push("phone" + i.toString() + "_star");
        name_list.push("headphone" + i.toString() + "_star");
        name_list.push("keyboard" + i.toString() + "_star");
    }
    var mark = 0;
 ...
 function cart_remove(current_star){
